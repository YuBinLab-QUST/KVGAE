...
'''
Select different pre-training parameters according to different cnn models.
Extract features from the image and add these features to the given data structure self.adata.
