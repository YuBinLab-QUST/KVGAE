...
'''
The neighbor distance between nodes is calculated according to different distance measurement methods.
Converts the edge list to an adjacency dictionary.
The adjacency matrix was normalized and converted to PyTorch sparse tensor format.
'''
class graph():
    def __init__(self, 
                data, 
